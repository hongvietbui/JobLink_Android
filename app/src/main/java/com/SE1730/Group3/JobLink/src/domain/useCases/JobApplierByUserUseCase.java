...
public class JobApplierByUserUseCase {
    private final IJobRepository jobRepository;

    @Inject
    public JobApplierByUserUseCase(IJobRepository jobRepository) {
    ...
    public Observable<ApiResp<Pagination<JobDTO>>> execute(int pageIndex, int pageSize, String sortBy, boolean isDescending) throws IOException {
        return jobRepository.getJobsAppliedByUser(pageIndex, pageSize, sortBy, isDescending);
    }
}
